...
SimpleForm.setup do |config|
  ...
  config.wrappers(:vertical_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label',
                                               tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid'
  ) do |b|
    b.use(:html5)
    b.optional(:readonly)
    b.wrapper(:legend_tag, tag: 'legend', class: 'col-form-label pt-0') do |ba|
  ...
  config.wrappers(:horizontal_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', tag: 'div',
                                          class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid'
  ) do |b|
    b.use(:html5)
    b.optional(:readonly)
  ...
  config.wrappers(:horizontal_collection_inline, item_wrapper_class: 'form-check form-check-inline', item_label_class: 'form-check-label',
                                                 tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid'
  ) do |b|
    b.use(:html5)
    b.optional(:readonly)
    b.use(:label, class: 'col-sm-3 col-form-label pt-0')
  ...
  config.wrappers(:custom_collection, item_wrapper_class: 'custom-control', item_label_class: 'custom-control-label', tag: 'fieldset',
                                      class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid'
  ) do |b|
    b.use(:html5)
    b.optional(:readonly)
    b.wrapper(:legend_tag, tag: 'legend', class: 'col-form-label pt-0') do |ba|
